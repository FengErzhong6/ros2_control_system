...
def generate_launch_description():
    ...
    declared_args = [
        ...
        DeclareLaunchArgument("collision_description_package", default_value="marvin_system"),
        ...
        DeclareLaunchArgument("left_xyz", default_value="0 0.037 0.5118964"),
        DeclareLaunchArgument("left_rpy", default_value="-1.5707963 0 0"),
        DeclareLaunchArgument("right_xyz", default_value="0 -0.037 0.5118964"),
