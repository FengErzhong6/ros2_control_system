...
def generate_launch_description():
    ...
    use_wujihand_L = LaunchConfiguration("use_wujihand_L")
    use_wujihand_R = LaunchConfiguration("use_wujihand_R")
    left_hand_mount_xyz = LaunchConfiguration("left_hand_mount_xyz")
    left_hand_mount_rpy = LaunchConfiguration("left_hand_mount_rpy")
    left_palm_xyz = LaunchConfiguration("left_palm_xyz")
    left_palm_rpy = LaunchConfiguration("left_palm_rpy")
    right_hand_mount_xyz = LaunchConfiguration("right_hand_mount_xyz")
    right_hand_mount_rpy = LaunchConfiguration("right_hand_mount_rpy")
    right_palm_xyz = LaunchConfiguration("right_palm_xyz")
    right_palm_rpy = LaunchConfiguration("right_palm_rpy")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "left_xyz",
                default_value="0 0.037 0.5118964",
            ...
            DeclareLaunchArgument(
                "use_wujihand_L",
                default_value="true",
                description="Enable left Wuji hand visualization",
            ),
            DeclareLaunchArgument(
                "use_wujihand_R",
                default_value="true",
                description="Enable right Wuji hand visualization",
            ),
            DeclareLaunchArgument(
                "left_hand_mount_xyz",
                default_value="0 -0.095 0",
                description="Link7_L -> hand_mount_L translation",
            ),
            DeclareLaunchArgument(
                "left_hand_mount_rpy",
            ...
            DeclareLaunchArgument(
                "left_palm_xyz",
                default_value="0 0 0.016",
                description="hand_mount_L -> left_palm_link translation fine adjustment",
            ),
            DeclareLaunchArgument(
                "left_palm_rpy",
                default_value="0 0 3.1415926",
                description="hand_mount_L -> left_palm_link rotation fine adjustment",
            ),
            DeclareLaunchArgument(
                "right_hand_mount_xyz",
                default_value="0 -0.095 0",
                description="Link7_R -> hand_mount_R translation",
            ),
            DeclareLaunchArgument(
                "right_hand_mount_rpy",
            ...
            DeclareLaunchArgument(
                "right_palm_xyz",
                default_value="0 0 0.016",
                description="hand_mount_R -> right_palm_link translation fine adjustment",
            ),
            DeclareLaunchArgument(
                "right_palm_rpy",
                default_value="0 0 3.1415926",
                description="hand_mount_R -> right_palm_link rotation fine adjustment",
            ),
            DeclareLaunchArgument(
                "model",
                default_value=[
                    FindPackageShare("marvin_system"),
                    "/description/urdf/marvin_wuji.urdf",
                ],
